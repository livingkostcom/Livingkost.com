    ...
    <div class="space-y-4">
        ...
        @empty
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 text-center">
                ...
                <button wire:click="openCreate" class="mt-3 text-sm text-blue-600 hover:text-blue-800 font-medium">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" wire:model="title" placeholder="Contoh: AC tidak dingin"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition @error('title') border-red-500 @enderror">
                            @error('title')
                        ...
                        <div>
                            ...
                            <textarea wire:model="description" rows="3" placeholder="Jelaskan masalah secara detail..."
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition @error('description') border-red-500 @enderror"></textarea>
                            @error('description')
                                <span class="text-xs text-red-500 mt-1">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        @if ($selectedRequest->admin_notes)
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-3">
                                <label class="text-xs font-medium text-blue-600 uppercase">Catatan dari Admin</label>
                                <p class="text-sm text-gray-700 mt-1 whitespace-pre-line">
