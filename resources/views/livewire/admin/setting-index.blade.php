            ...
            <div class="p-6 space-y-5">
                ...
                <div class="border-t border-gray-100 pt-5">
                    ...
                    <div class="relative">
                        ...
                        <input wire:model="dp_amount" type="number" min="0" max="500000" step="1000" placeholder="0"
                    ...
                    <p class="text-xs text-gray-500 mt-1">DP yang harus dibayar calon penyewa saat mengisi formulir pendaftaran mandiri (<b>maksimal Rp 500.000</b>). Isi <b>0</b> untuk menonaktifkan DP. Jika kos Anda bermitra pembayaran online, calon penyewa diarahkan ke pembayaran DOKU; jika tidak, mereka transfer ke rekening di atas & unggah bukti.</p>
                    @error('dp_amount')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
