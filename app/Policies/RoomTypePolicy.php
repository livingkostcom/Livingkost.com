...
class RoomTypePolicy
{
    ...
    {
        return $user->hasPermissionTo('view-room-types');
    }
    ...
    {
        return $user->hasPermissionTo('create-room-type');
    }
    ...
    {
        return $user->hasPermissionTo('edit-room-type');
    }
    ...
    {
        return $user->hasPermissionTo('delete-room-type');
    }
