...
class Property extends Model
{
    ...
    protected $fillable = ['owner_id', 'name', 'address', 'description', 'status', 'gender_type', 'is_featured', 'featured_image', 'gallery', 'location_label', 'badge_text', 'maps_url', 'common_facilities'];
